...
It shows all hosts and variables in JSON format.

## QUESTION B

What happens if you run `ansible-inventory --graph` in the directory you created above?

Det visar inventariet som ett diagram (grupper och deras maskiner).
...
Innebär att att Ansible körs lokalt på datorn, inte via ssh.
