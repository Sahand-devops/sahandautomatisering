...
Den ändrar eller upddaterar inställningarna från modulerna.

What does the output look like the second time you run this playbook?

Andra gången går den igenom modulerna och märker att inställningarna är redan gjorda, 
...
Orsakar onödiga omstarter varje gång. Med "notify" startas den om bara när man gjort ändringar. 
